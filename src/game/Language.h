...
//                                      = 783, not used
    ...
    LANG_OPVP_EP_LOSE_NPT_H             = 10011,
    LANG_OPVP_EP_LOSE_NPT_A             = 10012,
    LANG_OPVP_EP_LOSE_EWT_H             = 10013,
    LANG_OPVP_EP_LOSE_EWT_A             = 10014,
    LANG_OPVP_EP_LOSE_CGT_H             = 10015,
    LANG_OPVP_EP_LOSE_CGT_A             = 10016,
    LANG_OPVP_EP_LOSE_PWT_H             = 10017,
    LANG_OPVP_EP_LOSE_PWT_A             = 10018,
    ...
    LANG_OPVP_HP_LOSE_OVERLOOK_H        = 10025,
    LANG_OPVP_HP_LOSE_OVERLOOK_A        = 10026,
    LANG_OPVP_HP_LOSE_STADIUM_H         = 10027,
    LANG_OPVP_HP_LOSE_STADIUM_A         = 10028,
    LANG_OPVP_HP_LOSE_BROKENHILL_H      = 10029,
    LANG_OPVP_HP_LOSE_BROKENHILL_A      = 10030,
    ...
    LANG_OPVP_ZM_LOSE_WEST_H            = 10037,
    LANG_OPVP_ZM_LOSE_WEST_A            = 10038,
    LANG_OPVP_ZM_LOSE_EAST_H            = 10039,
    LANG_OPVP_ZM_LOSE_EAST_A            = 10040,
    LANG_OPVP_ZM_LOSE_GY_H              = 10041,
    LANG_OPVP_ZM_LOSE_GY_A              = 10042,

    LANG_OPVP_TF_CAPTURE_H              = 10047,
    LANG_OPVP_TF_CAPTURE_A              = 10048,
    LANG_OPVP_TF_LOSE_H                 = 10049,
    LANG_OPVP_TF_LOSE_A                 = 10050,

    LANG_OPVP_NA_CAPTURE_H              = 10043,
    LANG_OPVP_NA_CAPTURE_A              = 10044,
    LANG_OPVP_NA_LOSE_H                 = 10045,
    LANG_OPVP_NA_LOSE_A                 = 10046,
