...
//                                      = 783, not used
    ...
    LANG_OPVP_EP_CAPTURE_CGT_H          = 10005,
    LANG_OPVP_EP_CAPTURE_CGT_A          = 10006,
    LANG_OPVP_EP_CAPTURE_EWT_H          = 10007,
    LANG_OPVP_EP_CAPTURE_EWT_A          = 10008,
    LANG_OPVP_EP_CAPTURE_PWT_H          = 10009,
    LANG_OPVP_EP_CAPTURE_PWT_A          = 10010,

    LANG_OPVP_HP_CAPTURE_OVERLOOK_H     = 10011,
    LANG_OPVP_HP_CAPTURE_OVERLOOK_A     = 10012,
    LANG_OPVP_HP_CAPTURE_STADIUM_H      = 10013,
    LANG_OPVP_HP_CAPTURE_STADIUM_A      = 10014,
    LANG_OPVP_HP_CAPTURE_BROKENHILL_H   = 10015,
    LANG_OPVP_HP_CAPTURE_BROKENHILL_A   = 10016,

    LANG_OPVP_ZM_CAPTURE_EAST_BEACON_H  = 10017,
    LANG_OPVP_ZM_CAPTURE_EAST_BEACON_A  = 10018,
    LANG_OPVP_ZM_CAPTURE_WEST_BEACON_H  = 10019,
    LANG_OPVP_ZM_CAPTURE_WEST_BEACON_A  = 10020,
    LANG_OPVP_ZM_CAPTURE_BOTH_BEACONS_H = 10021,
    LANG_OPVP_ZM_CAPTURE_BOTH_BEACONS_A = 10022,
    LANG_OPVP_ZM_SPAWN_FIELD_SCOUT_H    = 10023,
    LANG_OPVP_ZM_SPAWN_FIELD_SCOUT_A    = 10024,
    LANG_OPVP_ZM_CAPTURE_GRAVEYARD_H    = 10025,
    LANG_OPVP_ZM_CAPTURE_GRAVEYARD_A    = 10026,

    LANG_OPVP_TF_CAPTURE_TOWER_H        = 10027,
    LANG_OPVP_TF_CAPTURE_TOWER_A        = 10028,
    LANG_OPVP_TF_LOSE_TOWER_H           = 10029,
    LANG_OPVP_TF_LOSE_TOWER_A           = 10030,
    LANG_OPVP_TF_CAPTURE_ALL_TOWERS_H   = 10031,
    LANG_OPVP_TF_CAPTURE_ALL_TOWERS_A   = 10032,

    LANG_OPVP_NA_PROGRESS_H             = 10033,
    LANG_OPVP_NA_PROGRESS_A             = 10034,
    LANG_OPVP_NA_CAPTURE_H              = 10035,
    LANG_OPVP_NA_CAPTURE_A              = 10036,
    LANG_OPVP_NA_DEFENSELESS            = 10037,
