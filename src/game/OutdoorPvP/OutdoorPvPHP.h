...
{
    {
        ...
        {EVENT_OVERLOOK_NEUTRAL_HORDE,          TEAM_NONE,  LANG_OPVP_HP_LOSE_OVERLOOK_A,       WORLD_STATE_OVERLOOK_NEUTRAL,       GO_ARTKIT_OVERLOOK_NEUTRAL,     CAPTURE_ANIM_NEUTRAL},
        {EVENT_OVERLOOK_NEUTRAL_ALLIANCE,       TEAM_NONE,  LANG_OPVP_HP_LOSE_OVERLOOK_H,       WORLD_STATE_OVERLOOK_NEUTRAL,       GO_ARTKIT_OVERLOOK_NEUTRAL,     CAPTURE_ANIM_NEUTRAL},
    },
    {
        ...
        {EVENT_STADIUM_NEUTRAL_HORDE,           TEAM_NONE,  LANG_OPVP_HP_LOSE_STADIUM_A,        WORLD_STATE_STADIUM_NEUTRAL,        GO_ARTKIT_STADIUM_NEUTRAL,      CAPTURE_ANIM_NEUTRAL},
        {EVENT_STADIUM_NEUTRAL_ALLIANCE,        TEAM_NONE,  LANG_OPVP_HP_LOSE_STADIUM_H,        WORLD_STATE_STADIUM_NEUTRAL,        GO_ARTKIT_STADIUM_NEUTRAL,      CAPTURE_ANIM_NEUTRAL},
    },
    {
        ...
        {EVENT_BROKEN_HILL_NEUTRAL_HORDE,       TEAM_NONE,  LANG_OPVP_HP_LOSE_BROKENHILL_A,     WORLD_STATE_BROKEN_HILL_NEUTRAL,    GO_ARTKIT_BROKEN_HILL_NEUTRAL,  CAPTURE_ANIM_NEUTRAL},
        {EVENT_BROKEN_HILL_NEUTRAL_ALLIANCE,    TEAM_NONE,  LANG_OPVP_HP_LOSE_BROKENHILL_H,     WORLD_STATE_BROKEN_HILL_NEUTRAL,    GO_ARTKIT_BROKEN_HILL_NEUTRAL,  CAPTURE_ANIM_NEUTRAL},
    },
};
