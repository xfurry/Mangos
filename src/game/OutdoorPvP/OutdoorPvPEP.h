...
enum
{
    ...
    //WORLD_STATE_PLAGUEWOOD_PROGRESS_HORDE     = 2369,
    ...
    //WORLD_STATE_NORTHPASS_PROGRESS_HORDE      = 2365,
    ...
    //WORLD_STATE_EASTWALL_PROGRESS_HORDE       = 2358,
    ...
    //WORLD_STATE_CROWNGUARD_PROGRESS_HORDE     = 2377,
...
{
    {
        ...
        {EVENT_NORTHPASS_NEUTRAL_HORDE,         TEAM_NONE,  LANG_OPVP_EP_LOSE_NPT_A,    WORLD_STATE_NORTHPASS_NEUTRAL},
        {EVENT_NORTHPASS_NEUTRAL_ALLIANCE,      TEAM_NONE,  LANG_OPVP_EP_LOSE_NPT_H,    WORLD_STATE_NORTHPASS_NEUTRAL},
    },
    {
        ...
        {EVENT_CROWNGUARD_NEUTRAL_HORDE,        TEAM_NONE,  LANG_OPVP_EP_LOSE_CGT_A,    WORLD_STATE_CROWNGUARD_NEUTRAL},
        {EVENT_CROWNGUARD_NEUTRAL_ALLIANCE,     TEAM_NONE,  LANG_OPVP_EP_LOSE_CGT_H,    WORLD_STATE_CROWNGUARD_NEUTRAL},
    },
    {
        ...
        {EVENT_EASTWALL_NEUTRAL_HORDE,          TEAM_NONE,  LANG_OPVP_EP_LOSE_EWT_A,    WORLD_STATE_EASTWALL_NEUTRAL},
        {EVENT_EASTWALL_NEUTRAL_ALLIANCE,       TEAM_NONE,  LANG_OPVP_EP_LOSE_EWT_H,    WORLD_STATE_EASTWALL_NEUTRAL},
    },
    {
        ...
        {EVENT_PLAGUEWOOD_NEUTRAL_HORDE,        TEAM_NONE,  LANG_OPVP_EP_LOSE_PWT_A,    WORLD_STATE_PLAGUEWOOD_NEUTRAL},
        {EVENT_PLAGUEWOOD_NEUTRAL_ALLIANCE,     TEAM_NONE,  LANG_OPVP_EP_LOSE_PWT_H,    WORLD_STATE_PLAGUEWOOD_NEUTRAL},
    },
};
