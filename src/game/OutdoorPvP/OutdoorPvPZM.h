...
{
    {
        ...
        {EVENT_EAST_BEACON_NEUTRAL_HORDE,       TEAM_NONE,  LANG_OPVP_ZM_LOSE_EAST_A,       WORLD_STATE_TOWER_EAST_NEUTRAL,     WORLD_STATE_BEACON_EAST_NEUTRAL},
        {EVENT_EAST_BEACON_NEUTRAL_ALLIANCE,    TEAM_NONE,  LANG_OPVP_ZM_LOSE_EAST_H,       WORLD_STATE_TOWER_EAST_NEUTRAL,     WORLD_STATE_BEACON_EAST_NEUTRAL},
    },
    {
        ...
        {EVENT_WEST_BEACON_NEUTRAL_HORDE,       TEAM_NONE,  LANG_OPVP_ZM_LOSE_WEST_A,       WORLD_STATE_TOWER_WEST_NEUTRAL,     WORLD_STATE_BEACON_WEST_NEUTRAL},
        {EVENT_WEST_BEACON_NEUTRAL_ALLIANCE,    TEAM_NONE,  LANG_OPVP_ZM_LOSE_WEST_H,       WORLD_STATE_TOWER_WEST_NEUTRAL,     WORLD_STATE_BEACON_WEST_NEUTRAL},
    },
};
